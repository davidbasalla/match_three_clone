var MatchingShapeFinder = function(board, logger){
  this.board = board;
  this.logger = logger;
}
...
MatchingShapeFinder.prototype.matching_shape_for = function(gem){
...
MatchingShapeFinder.prototype.matching_gems = function(gem, horizontal_or_vertical){
...
MatchingShapeFinder.prototype.walk_matching_gems = function(gem, vector){
...
MatchingShapeFinder.prototype.unique_shapes = function(shapes){
  var unique_shapes = []
...
MatchingShapeFinder.prototype.shape_included_in_shapes = function(original_shape, shapes){
