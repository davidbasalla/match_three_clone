...
class MatchingShapeFinder {
  ...
  matching_gems(gem, horizontal_or_vertical) {
    ...
    matching_gems = matching_gems.concat(
      this.walk_matching_gems(gem, vector_1)
    );
    matching_gems = matching_gems.concat(
      this.walk_matching_gems(gem, vector_2)
    );
  ...
  walk_matching_gems(gem, vector) {
    ...
    while (next_gem && next_gem.color == gem.color && next_gem.pos_y >= 0) {
